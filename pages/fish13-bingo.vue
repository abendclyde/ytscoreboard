	...
	<div class="min-h-[calc(100vh-4rem)] flex justify-center p-4 pt-8">
		...
		>
			...
			<UCard class="info-panel min-w-80 flex flex-col flex-shrink-0">
				...
				</div> <!-- Scrollable Marked Items List -->                <h3 class="font-semibold mb-2 mt-4">
					Markierte Felder:
				</h3>
...
// Fish13 Bingo mit dem neuen Composable
const {
	bingoGrid,
	gridKey,
	isLoading,
...
// Seitentitel
useHead({
	title: 'Fish13 Bingo - Camping Abenteuer',
	meta: [
		{ name: 'description', content: 'Spiele Bingo mit Fish13s Camping-Abenteuern und Erlebnissen' },
	],
})
</script>

<style scoped>
/* Spezifische Styles für Fish13 Bingo können hier hinzugefügt werden */
</style>
